      ...
      >
        {screen === "topic" && (
          <form onSubmit={submitTopic}>
            ...
            {/* Второй кнопки пропуска здесь намеренно нет: «Пропустить» живёт
                в шапке визарда (PlanningQuestionPopover) и доступно на КАЖДОМ
                шаге, а не только на первом. Прежняя нижняя кнопка вдобавок
                вела себя иначе — собирала фиктивный план с темой «Свободный
                вопрос», из-за чего все такие чаты получали одинаковый
