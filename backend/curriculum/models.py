...
# 1.2.0 — переписано определение заголовков (`blocks.py`). На «Механике»
# Мякишева прежние правила давали 1151 «раздел» вместо ~300: сноски,
# нумерованные вопросы и колонцифры принимались за заголовки, разорванные по
...
# переобработать.
# 1.4.0 — структура берётся из закладок PDF, когда они есть: это разметка
# издателя, и она точнее печатного оглавления. Плюс снят лимит в 400 страниц и
# исправлены уровни у EPUB. Меняются и состав разделов, и их уровни, и объём
# обработанного текста — книги нужно переобработать.
PROCESSING_VERSION = "1.4.0"
